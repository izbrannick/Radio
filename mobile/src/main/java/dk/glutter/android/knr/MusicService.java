...
import dk.glutter.android.knr.model.RemoteSource;
import dk.glutter.android.knr.playback.CastPlayback;
import dk.glutter.android.knr.playback.LocalPlayback;
import dk.glutter.android.knr.playback.Playback;
import dk.glutter.android.knr.playback.PlaybackManager;
import dk.glutter.android.knr.playback.QueueManager;
import dk.glutter.android.knr.ui.NowPlayingActivity;
import dk.glutter.android.knr.utils.CarHelper;
import dk.glutter.android.knr.utils.LogHelper;
import dk.glutter.android.knr.utils.WearHelper;

import static dk.glutter.android.knr.utils.MediaIDHelper.MEDIA_ID_ROOT;
...
public class MusicService extends MediaBrowserServiceCompat implements
    ...
    public static final String EXTRA_CONNECTED_CAST = "dk.glutter.android.knr.CAST_NAME";
    // The action of the incoming Intent indicating that it contains a command
    // to be executed (see {@link #onStartCommand})
    public static final String ACTION_CMD = "dk.glutter.android.knr.ACTION_CMD";
    ...
    public MediaSessionCompat getMusicSession()
    {
        return mSession;
    }
    ...
    public void onCreate() {
        ...
        mPackageValidator = new PackageValidator(MusicService.this);
        ...
        mPlaybackManager = new PlaybackManager(MusicService.this, getResources(), mMusicProvider, queueManager,
                playback);


        // Start a new MediaSession
        mSession = new MediaSessionCompat(MusicService.this, "MusicService");
        ...
        if(handler == null) {
            ...
            runnable = new Runnable()
            {
                public void run()
                {
                    ...
                    /*
                    Algorithm to find how much time is left
                    st  - Start time 19.58
                    nt  - Now time 20:00
                    dur - Duration 3
                    tp  - Time Played
                    tl  - Time Left (when to update)
