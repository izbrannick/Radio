...
import static dk.glutter.android.knr.utils.MediaIDHelper.MEDIA_ID_MUSICS_BY_GENRE;
import static dk.glutter.android.knr.utils.MediaIDHelper.MEDIA_ID_ROOT;
import static dk.glutter.android.knr.utils.MediaIDHelper.createMediaID;
    ...
    private MediaBrowserCompat.MediaItem createBrowsableMediaItemForRoot(Resources resources) {
        MediaDescriptionCompat description = new MediaDescriptionCompat.Builder()
                ...
                .setIconUri(Uri.parse("android.resource://" +
                        "dk.glutter.android.knr/drawable/ic_by_genre"))
                .build();
