...
import dk.glutter.android.knr.ui.MusicPlayerActivity;
import dk.glutter.android.knr.utils.LogHelper;
import dk.glutter.android.knr.utils.ResourceHelper;
...
public class MediaNotificationManager extends BroadcastReceiver {
    ...
    public static final String ACTION_PAUSE = "dk.glutter.android.knr.pause";
    public static final String ACTION_PLAY = "dk.glutter.android.knr.play";
    public static final String ACTION_PREV = "dk.glutter.android.knr.prev";
    public static final String ACTION_NEXT = "dk.glutter.android.knr.next";
    public static final String ACTION_STOP_CASTING = "dk.glutter.android.knr.stop_cast";
    ...
    private void addPlayPauseAction(NotificationCompat.Builder builder) {
        ...
        if (mPlaybackState.getState() == PlaybackStateCompat.STATE_PLAYING) {
            ...
            icon = R.drawable.knr_ic_pause_white_24dp;
            intent = mPauseIntent;
        } else {
            label = mService.getString(R.string.label_play);
            icon = R.drawable.knr_ic_play_arrow_white_24dp;
            intent = mPlayIntent;
        }
